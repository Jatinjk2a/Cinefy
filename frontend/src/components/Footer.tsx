      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div>
          ...
          <p className="text-sm leading-relaxed">
            Premium 4K streaming. Discover millions of movies and TV shows anytime, anywhere.
          </p>
        ...
        <div>
          ...
          {isHydrated ? (
            ...
            <div className="flex flex-col space-y-2">
              <div className="bg-gray-800 text-gray-500 px-3 py-2 rounded-md text-sm">Enter your email</div>
              <div className="bg-pink-600 text-white px-3 py-2 rounded-md text-sm">Subscribe</div>
            </div>
          )}
        </div>
      </div>
